...
export default function ContactMail({isOfferForm, selectedServiceName = null, firstName, lastName, email, phone, message}) {
    const MailHeading = () => {
        if(isOfferForm) {
            return `${firstName}, ${selectedServiceName} için iletişime geçmek istiyor`
        } else {
                                ...
                                <Row className='grid gap-4'>
                                    ...
                                    <Row className='mt-4 pt-4 border-t border-gray-200'>
                                        <Column className='flex justify-between align-center items-center content-center gap-4'>
                                            <Button href={`mailto:${email}`} className="w-3/6 p-6 bg-[#164DD6] pl-2 text-white rounded-xl text-center text-lg">Yanıtla</Button>
